"""
Evals for invitation extraction field quality.

These assess LLM output quality using fuzzy matching and heuristics.
Some failure is expected -- these measure quality trends, not correctness.
...
# ============================================================================
# Field Quality Evals (Fuzzy/Threshold Based)
# ============================================================================
...
async def test_invitation_field_integrity(test_case):
    """Eval that invitation fields match ground truth using fuzzy logic."""
    ...
    # TODO: Skipped until proposed_times returns structured datetime ranges
