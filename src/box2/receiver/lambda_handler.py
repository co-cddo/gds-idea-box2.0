...
QA_INVITATION_LIST_NAME = os.environ.get("QA_INVITATION_LIST_NAME", "QA Invitations")
REJECTED_INVITATION_LIST_NAME = os.environ.get("REJECTED_INVITATION_LIST_NAME", "Rejected Invitations")
